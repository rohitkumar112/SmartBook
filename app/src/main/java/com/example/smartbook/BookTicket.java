    ...
    private void onClickListener() {
        submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent=new Intent(BookTicket.this, CancelTicket.class);
        ...
        submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if(isValid()&&!selectedDeparture.equals(selectedArrival))
                {
                    ...
                    Booking booking_dialog=new Booking(BookTicket.this, selectedDeparture, selectedArrival, selectedDate,fare, new DIalogListener() {
                        @Override
                ...
                {
                    Toast.makeText(BookTicket.this,"departure should be different from arrival",Toast.LENGTH_LONG).show();
                }
            }
        });
        select_date.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                final int month=1;
                final int date=5;
                final DatePickerDialog mdiDialog =new DatePickerDialog(BookTicket.this,new DatePickerDialog.OnDateSetListener() {
                    @Override
